...
from OnlineShop.utils.common import (
    ...
    def post(self, request):
        ...
        if count >= constants.USER_ADDRESS_COUNTS_LIMIT:
            return http.JsonResponse(
                {"code": RETCODE.THROTTLINGERR, "errmsg": "超过地址数量上限"}
            )
...
class ChangePasswordView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        try:
            ...
            logger.error(e)
            return render(
                request, "user_center_pass.html", {"origin_pwd_errmsg": "原始密码错误"}
            )
        ...
        try:
            ...
            logger.error(e)
            return render(
                request, "user_center_pass.html", {"change_pwd_errmsg": "修改密码失败"}
            )
